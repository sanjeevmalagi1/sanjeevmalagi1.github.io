(function() {
  ...
  LogsInfoURLController.$inject = ['$scope','$state','$stateParams','$location','$anchorScroll','websiteService'];

  function LogsInfoURLController($scope,$state,$stateParams,$location,$anchorScroll,websiteService) {
